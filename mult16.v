module Complete_MIPS(CLK, RST, A_Out, D_Out, HALT);
...
module Memory(CS, WE, CLK, ADDR, Mem_Bus);
    ...
    $readmemh("C:\\Users\\dgonz\\Downloads\\Lab5\\mult16HEX.txt", RAM);
    end
...
module MIPS (CLK, RST, CS, WE, ADDR, Mem_Bus, HALT, reg1_out);
    input CLK, RST, HALT;
    output reg CS, WE;
    output [6:0] ADDR;
    inout [31:0] Mem_Bus;
    ...
    assign MULT16 = (fetchDorI) ? pc : alu_result_save[6:0];
  ...
  //assign reg1_out = Register.REG(1);
endmodule
